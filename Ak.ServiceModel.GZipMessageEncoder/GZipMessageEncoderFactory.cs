...
namespace Ak.ServiceModel.GZipMessageEncoder
{
    ...
    internal class GZipMessageEncoderFactory : MessageEncoderFactory
    {
        ...
        class GZipMessageEncoder : System.ServiceModel.Channels.MessageEncoder
        {
            ...
            System.ServiceModel.Channels.MessageEncoder innerEncoder;
